const messages1 = ["You’re off to great places.","No one is perfect.","Winning doesn't always mean being first. Winning means you're doing better than you've done before.","You're braver than you believe.",
...
const combineMessages = (arr1, arr2, arr3) => {
...
const showMessage = () => {  
    const dom = document.getElementById('quote')
    const finalMessage = combineMessages(messages1, messages2, messages3)
    dom.innerHTML = finalMessage
}
